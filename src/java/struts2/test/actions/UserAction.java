...
//            String html = "<html><h2>Log4j has been initialized successfully!</h2></html>";
    ...
    public String updateUser() throws Exception {
        ...
        try {
            if (getSubmitType().equals("updatedata")) {
                User user = getDao().fetchUserDetails(userName.trim());
                if (user != null) {
                ...
                int i = getDao().updateUserDetails(userName, password, firstName, lastName,
                        email, phoneNumber);
                if (i > 0) {
    ...
    public String deleteUser() throws Exception {
        try {
            int isDeleted = getDao().deleteUserDetails(userName);
            if (isDeleted > 0) {
